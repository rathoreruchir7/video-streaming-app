  ...
  function ChannelVideos(props){
    ...
    if(!spinner){
        return (
            ...
            <div style={{marginLeft: '100px', marginTop: '20px',float: 'left', fontSize: '15px',  display: 'flex', justifyContent: 'center', alignItems: 'center', cursor: 'pointer'}} >
                   <Avatar  style={{width: '40px', height: "40px", marginRight: '10px'}} />
                   <div>{}</div>
            </div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ChannelVideos))